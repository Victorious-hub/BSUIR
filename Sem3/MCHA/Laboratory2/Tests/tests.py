...
class TryTesting(TestCase):
    ...
    test_matrix5 = np.array([[10.,1.,1.], [2.,10.,1.],[2.,2.,10.]])
    test_vector5 = np.array([4.,6.])

    test_matrix6 = np.array([
        [2.39,-0.21,0.05,1.12,-1.13],
    [-1.07,-2.27,-0.23,0.01,1.12],
    [1.12,-1.07,-2.27,-0.11,0.05],
    [0.17,1.12,-1.07,-2.27,-0.11],
    [-0.11,-0.67,1.12,-1.07,-2.27]])

    test_vector6 = np.array([5.,6.,7.,8.,9.])
